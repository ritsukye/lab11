...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            for (TreeNode child: children)
            {
            	...
            	TreeNode returnValue = child.getNodeWithName(targetName);
            	if (returnValue != null) {
            		return returnValue;
            	}
            }
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("The line is formatted incorrectly!"); //throw a TreeException with a useful message
		...
		else
		{
			...
			if (parentNode == null) {
				throw new TreeException("Something wrong with datafile!");	
		}
		
		// Add child nodes to parentNode.
		for (String child: childrenArray) {
			TreeNode toBeAdded = new TreeNode(child);
			parentNode.addChild(toBeAdded);
			}
		}
